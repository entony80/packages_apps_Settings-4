...
package com.android.settings.cypher.widgets;
...
import com.android.settings.cypher.widgets.SmartDialogHelper;

public class SettingConfirmationSnackbarView extends RelativeLayout {

    /** Whether to output debugging information to logs. */
    private static final boolean DEBUG = SmartDialogHelper.DEBUG;
    /** Log output tag. */
    private static final String LOG_TAG = SmartDialogHelper.LOG_TAG;
    ...
    private SmartDialogHelper.OnSettingChoiceListener mCallback = null;
     ...
     * @param listener  {@link SmartDialogHelper.OnSettingChoiceListener} to notify
     *                  about the choice
    ...
    public void show(final String settingName, final String message,
            final SmartDialogHelper.OnSettingChoiceListener callback,
            Handler handler) {
        if (settingName == null) {
