...
public class QuickSettings extends SettingsPreferenceFragment
	...
	private static final int MENU_HEADER_COLORS = Menu.FIRST;
	private static final int MENU_HEADER_FONTS = Menu.FIRST + 2;
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {		
		MenuItem quicksettingscolors = menu.add(0, MENU_HEADER_COLORS, 0, R.string.quick_settings_theme_colors);
		.setIcon(R.drawable.ic_qs_colors)
        quicksettingscolors.setShowAsAction(MenuItem.SHOW_AS_ACTION_IF_ROOM);
		
		MenuItem quicksettingsfonts = menu.add(0, MENU_HEADER_FONTS, 0, R.string.quick_settings_theme_fonts);
		.setIcon(R.drawable.ic_qs_fonts)
        quicksettingsfonts.setShowAsAction(MenuItem.SHOW_AS_ACTION_IF_ROOM);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
			case MENU_HEADER_COLORS:
                final SettingsActivity sa = (SettingsActivity) getActivity();
                sa.startPreferencePanel(QuickSettingsColors.class.getName(), null,
                        R.string.quick_settings_theme_colors, null, null, 0);
                return true;
			case MENU_HEADER_FONTS:
                final SettingsActivity sat = (SettingsActivity) getActivity();
                sat.startPreferencePanel(QuickSettingsFonts.class.getName(), null,
                        R.string.quick_settings_theme_fonts, null, null, 0);
                return true;
            default:
